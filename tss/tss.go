...
func (t *TssServer) joinParty(msgID string, keys []string, peerStreams map[peer.ID]network.Stream) ([]peer.ID, error) {
	...
	onlinePeers, err := t.partyCoordinator.JoinPartyWithRetry(joinPartyReq, peerIDs, peerStreams)
